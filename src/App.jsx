   ...
   const handleGenerate = async (isUpdate = false) => {
    ...
    const prompt = `
        ...
        2.  For 'legalReference', you MUST follow this **three-step internal process**:
            ...
            **Step B: Find a School-Specific Case.** Second, find a real, verifiable court case from a **K-12 public or independent school context** that deals with the concepts from Step A. Your search should prioritize sources like Justia, Casetext, Westlaw, FindLaw, Fastcase, CourtListener, and the Legal Information Institute, and relevant verified case law found on search engines. Do not provide case law references that do not match the exact complaint or concept.
