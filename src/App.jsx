   ...
   const handleGenerate = async (isUpdate = false) => {
    ...
    const prompt = `
        ...
        2.  For 'legalReference', you MUST follow this **three-step internal process**:
            ...
            **Step C: Justify the Selection.** Third, in your final output, provide the case name and a concise explanation that **explicitly connects the legal principle with the complaint or issue**.
